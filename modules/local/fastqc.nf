process FASTQC {
    ...
    // Stage-rename the inputs so MultiQC reports sample IDs instead of raw FASTQ filenames.
    // ext.prefix distinguishes the raw and trimmed invocations (see conf/modules.config).
    ...
    fastqc --quiet --threads $task.cpus $args $renamed_files
